...
void main() {
  ...
  group('Testes de Aceitação', () {
    testWidgets('Testa o fluxo completo de um usuário', (WidgetTester tester) async {
      app.main();
      ...
      // Verifica se a tela de Transferência foi aberta
      ...
      // Realiza uma ação no botão "Cobrar"
      await tester.tap(find.text('Cobrar'));
      await tester.pumpAndSettle();

      // Verifica se a tela de Cobrança foi aberta
      expect(find.byType(Charge), findsOneWidget);
